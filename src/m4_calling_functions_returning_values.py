...
def run_test_digits_in_cube():
    ...
    expected2 = 45
    answer2 = digits_in_cube(456)
    print('expected:', expected2)
    print(' actual:', answer2)

    expected3 = 45
    answer3 = digits_in_cube(789)
